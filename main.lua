...
local button = ui.Button(win, "Translate", 0, 480*ui.dpi-32*ui.dpi, 840*ui.dpi, 32*ui.dpi)
...
function button:onClick()
  outputEntry.text = "!@#$%^&*()"
	outputEntry.text = translate(entry.text, getLanguageCode(combo.selected.index), getLanguageCode(combo2.selected.index))
end
